...
SECRET_KEY = 'django-insecure-y#(ozw^4*8qu-rm13hpv=wf&f7u1hj0u8lg-k+sh!iupb+^j(%'
...
# Always use fake payments for testing
USE_FAKE_PAYMENT_CLIENT = True

# Remove or comment out Razorpay settings
